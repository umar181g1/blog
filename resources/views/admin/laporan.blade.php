                        ...
                        <tr>
                          ...
                          <td> <a class="btn btn-primary" target="_blank" href="{{asset(Storage::url($p['proposal']))}}">lihat detail</a>
                            ...
                            <td>
                              ...
                              <a href="{{asset(Storage::url($p['laporan']))}}" target="_blank" class="btn btn-secondary"><i class="fa fa-eye"></i>lihat</a>
                              @endif
                            </td>
                            <td>
                              @if($p['status_pengajuan'] == 2)
                              ...
                              <a href="/tolakLaporan/{{$p['id_laporan']}}" class="btn btn-danger konfirmasi"><i class="fas fa-times"></i>DiTolak</a>
                              @endif
                            </td>
                          </tr>
                        </tbody>
