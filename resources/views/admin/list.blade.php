                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$adm->email}}</td>
                        <td>{{$adm->alamat}}</td>
                        <td><button type="button" class="btn btn-secondary ubah" data-toggle="modal" data-target="#ubahModal" data-id_admin="{{$adm->id_admin}}" data-nama="{{$adm->nama}}"data-email="{{$adm->email}}" data-alamat="{{$adm->alamat}}"><i class="fas fa-edit"></i>ubah</button>
